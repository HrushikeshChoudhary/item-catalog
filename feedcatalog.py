...
engine = create_engine('sqlite:///catalog_database2.db', connect_args={'check_same_thread': False})
...
# Create dummy user
user1 = User(name="Hrushikesh", email="hrushikeshchoudhary@gmail.com", picture="https://cdn2.iconfinder.com/data/icons/happy-users/100/users09-512.png")
session.add(user1)
session.commit()
